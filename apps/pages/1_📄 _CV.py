...
Ich will nichts beschönigen, ja, ich war als Schüler in dieser Zeit verdammt lästig und habe ständig den Unterricht gestört. Aber ich habe nie etwas wirklich schlimmes, wie jemanden richtig verprügelt, verbrochen. Mein damaliges Verhalten äußerte sich vor allem darin, als Klassenclown für Unruhe zu sorgen.
...
⌛ Das Trampolin war ein Timeoutprojekt. Es bedeutete: Weg von der Schule, hin zu handwerklichem Arbeiten. Dieses Projekt half mir enorm. Hier bekam ich endlich das Gefühl, doch noch etwas wert zu sein, während die Lehrkräfte sich von mir erholen konnten. Parallel dazu begann ich im Club Basketball zu spielen, nahm Ritalin ein und hatte bald meine erste Freundin. Die Kombination dieser Faktoren gaben mir schließlich die richtige Richtung.
...
Meine anfänglichen Zweifel verflogen schnell. Ich begann zu verstehen, warum so viel Selbstdarstellung in dieser Branche nötig ist – schließlich müssen Investoren und Kunden überzeugt werden. Abseits des Verkaufens erlebte ich die Akteure als bodenständige und hart arbeitende Menschen.

Mittlerweile bin ich selbst Teil der Startup-Welt. In einem stundenlohnbezahlten Job bei einem jungen Unternehmen arbeite ich daran, [Fußballtransfers mithilfe von Crowdfunding](https://crowdtransfer.io) zu ermöglichen. Die Idee begeistert mich, und ich bin vom Erfolg des Projekts überzeugt. Daher habe ich sogar einen kleinen Anteil an Aktien erworben.
"""
)
